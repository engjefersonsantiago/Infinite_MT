...
\begin{figure*}[]
	...
	\subfloat[Hit Ratio. $SF=1\times$]{
		\includegraphics[width=0.3\textwidth]{../scripts/hit_ratio_sf1.pdf}
		\label{fig:hit_ratio_sf1}
	}
	\subfloat[Hit Ratio. $SF=10\times$]{
		\includegraphics[width=0.3\textwidth]{../scripts/hit_ratio_sf10.pdf}
		\label{fig:hit_ratio_sf10}
	}
	\subfloat[Hit Ratio. $SF=100\times$]{
		\includegraphics[width=0.3\textwidth]{../scripts/hit_ratio_sf100.pdf}
		\label{fig:hit_ratio_sf100}
	}\qquad
	\subfloat[Size Weighted Hit Ratio. $SF=1\times$]{
		\includegraphics[width=0.3\textwidth]{../scripts/weighted_hit_ratio_sf1.pdf}
		\label{fig:weighted_hit_ratio_sf1}
	}
	\subfloat[Size Weighted Hit Ratio. $SF=10\times$]{
		\includegraphics[width=0.3\textwidth]{../scripts/weighted_hit_ratio_sf10.pdf}
		\label{fig:weighted_hit_ratio_sf10}
	}
	\subfloat[Size Weighted Hit Ratio. $SF=100\times$]{
		\includegraphics[width=0.3\textwidth]{../scripts/weighted_hit_ratio_sf100.pdf}
...
To evaluate the efficiency of the proposed cache policies, we implemented the OPT algorithm~\cite{Belady:66} as a normalized upper-bound performance.
...
The simulation shows a noticeable increase (+10\%) in the size weighted hit ratio for when a random-based eviction policy is implemented.
