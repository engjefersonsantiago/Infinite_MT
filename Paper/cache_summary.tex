...
%\begin{algorithm}[]
%\caption{WLFU frequency update procedure}
%\label{algo:wlfu_update}
%\SetInd{0.1em}{.9em}
%\SetAlgoLined
%\footnotesize
%\SetKwProg{procedure}{Procedure}{}{end}
%\SetKwFunction{updateFrequencyCounter}{updateFrequencyCounter}
%\SetKwFunction{findEntryCounter}{findEntryCounter}
%
%\SetKwInOut{Input}{input}
%
%\Input{Cache memory: list of $\langle$\texttt{entry, counter}$\rangle$ pairs}
%\Input{Matched cache entry}
%\Input{Packet Size}
%\procedure{\updateFrequencyCounter{cache, matched\_entry, pkt\_size}}{
%
%	\tcc{Get a pointer to the hit entry}
%	entry\_found =  \findEntryCounter{cache, matched\_entry}
%	
...
%
%\begin{algorithm}[]
%\caption{WLFU replacement procedure}
%\label{algo:wlfu_repl}
%\SetInd{0.1em}{.9em}
%\SetAlgoLined
%\footnotesize
%\SetKwProg{procedure}{Procedure}{}{end}
%\SetKwFunction{replaceVictim}{replaceVictim}
%\SetKwFunction{minFrequencyCounter}{minFrequencyCounter}
%\SetKwInOut{Input}{input}
%\Input{Cache memory: list of $\langle$\texttt{entry, counter}$\rangle$ pairs}
%\Input{New cache entry}
%\Input{Packet Size}
%\procedure{\updateFrequencyCounter{cache, new\_entry, pkt\_size}}{
%
%	\tcc{Get a pointer to the victim}
%	victim =  \minFrequencyCounter{cache}
%	
%	\tcc{Updates the entry}
%	*victim = $\langle$new\_entry, pkt\_size$\rangle$
%}
%\end{algorithm}
