...
%		\includegraphics[width=0.45\textwidth]{fig_cdf_pkt.pdf}
%		\label{fig:cdf_pkt}
%	}\qquad
%	\subfloat[Size-weighted heavy hitter flows]{
%		\includegraphics[width=0.45\textwidth]{fig_cdf.pdf}
%		\label{fig:cdf}
%	}\\
%	\subfloat[Flow duration]{
%		\includegraphics[width=0.45\textwidth]{fig_duration.pdf}
%		\label{fig:flow_duration}
%	}\qquad
%	\subfloat[Average flow size]{
%		\includegraphics[width=0.45\textwidth]{fig_avg_flow_size.pdf}
%		\label{fig:flow_size}
%	}
