...
def gen_params(l1_slowdown_factor, l2_slowdown_factor, cpu_slowdown_factor, l1_cache_init, l2_cache_init, l1_cache_type, l2_cache_type, l1_cache_size, l2_cache_size, l1_stats_size, l2_stats_size, lfu_counter_type):
    dump_file = f"""
...
static constexpr auto LFU_COUNTER_TYPE = {lfu_counter_type};
...
if __name__ == "__main__":
    ...
    lfu_counter_type = sys.argv[12]
    write_hpp_file(gen_params(l1_slowdown_factor, l2_slowdown_factor, cpu_slowdown_factor, l1_cache_init, l2_cache_init, l1_cache_type, l2_cache_type, l1_cache_size, l2_cache_size, l1_stats_size, l2_stats_size, lfu_counter_type))
