...
static constexpr std::size_t CACHE_HOST_PROC_SLOWDOWN_FACTOR = 2;
...
static constexpr std::size_t L1_CACHE_SIZE = 2;
static constexpr std::size_t L2_CACHE_SIZE = 4;

static constexpr std::size_t L1_CACHE_STATS_SIZE = 2;
static constexpr std::size_t L2_CACHE_STATS_SIZE = 4;
